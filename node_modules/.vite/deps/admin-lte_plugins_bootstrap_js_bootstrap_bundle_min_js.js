  ...
  "node_modules/admin-lte/plugins/bootstrap/js/bootstrap.bundle.min.js"(exports, module) {
    !function(t, e) {
        ...
        for (var i2 in n2)
          if (Object.prototype.hasOwnProperty.call(n2, i2)) {
            ...
            if (!new RegExp(o2).test(a2))
              throw new Error(t2.toUpperCase() + ': Option "' + i2 + '" provided type "' + a2 + '" but expected type "' + o2 + '".');
          }
        var s2;
      ...
      u.jQueryDetection(), i.default.fn.emulateTransitionEnd = function(t2) {
        ...
        if (i.default(t2.target).is(this))
      ...
      var h = "bs.button", p = i.default.fn.button, m = "active", g = '[data-toggle^="button"]', _ = 'input:not([type="hidden"])', v = ".btn", b = function() {
        ...
        return e2.toggle = function() {
          ...
          if (n2) {
            ...
            if (o2) {
              if ("radio" === o2.type)
                if (o2.checked && this._element.classList.contains(m))
                  t3 = false;
                else {
      ...
      i.default(document).on("click.bs.button.data-api", g, function(t2) {
        ...
        if (i.default(e2).hasClass("btn") || (e2 = i.default(e2).closest(v)[0]), !e2 || e2.hasAttribute("disabled") || e2.classList.contains("disabled"))
          t2.preventDefault();
        else {
          var o2 = e2.querySelector(_);
          if (o2 && (o2.hasAttribute("disabled") || o2.classList.contains("disabled")))
      ...
      var y = "carousel", E = "bs.carousel", w = i.default.fn[y], T = "active", C = "next", S = "prev", N = "slid.bs.carousel", D = ".active.carousel-item", A = { interval: 5e3, keyboard: true, slide: false, pause: "hover", wrap: true, touch: true }, k = { interval: "(number|boolean)", keyboard: "boolean", slide: "(boolean|string)", pause: "(string|boolean)", wrap: "boolean", touch: "boolean" }, I = { TOUCH: "touch", PEN: "pen" }, O = function() {
        ...
        return e2.next = function() {
          ...
          if ((i2 && 0 === o2 || n2 && o2 === r2) && !this._config.wrap)
            return e3;
          ...
          if (t3 === C ? (n2 = "carousel-item-left", o2 = "carousel-item-next", r2 = "left") : (n2 = "carousel-item-right", o2 = "carousel-item-prev", r2 = "right"), f2 && i.default(f2).hasClass(T))
            this._isSliding = false;
            ...
            if (i.default(this._element).hasClass("slide")) {
              ...
              i.default(s2).removeClass(T), i.default(f2).addClass(T), this._isSliding = false, i.default(this._element).trigger(h2);
            c2 && this.cycle();
          }
        }, t2._jQueryInterface = function(e3) {
          return this.each(function() {
            ...
            if (n2 || (n2 = new t2(this, o2), i.default(this).data(E, n2)), "number" == typeof e3)
              n2.to(e3);
            else if ("string" == typeof r2) {
              if ("undefined" == typeof n2[r2])
                throw new TypeError('No method named "' + r2 + '"');
              n2[r2]();
            } else
              o2.interval && o2.ride && (n2.pause(), n2.cycle());
          });
      ...
      var x = "collapse", j = "bs.collapse", L = i.default.fn[x], P = "show", F = "collapse", R = "collapsing", H = "collapsed", M = "width", q = '[data-toggle="collapse"]', B = { toggle: true, parent: "" }, Q = { toggle: "boolean", parent: "(string|element)" }, W = function() {
        function t2(t3, e3) {
          ...
          for (var n2 = [].slice.call(document.querySelectorAll(q)), i2 = 0, o2 = n2.length; i2 < o2; i2++) {
        ...
        return e2.toggle = function() {
          ...
          if (!(this._isTransitioning || i.default(this._element).hasClass(P) || (this._parent && 0 === (e3 = [].slice.call(this._parent.querySelectorAll(".show, .collapsing")).filter(function(t3) {
            ...
            if (i.default(this._element).trigger(r2), !r2.isDefaultPrevented()) {
              ...
              i.default(this._element).removeClass(F).addClass(R), this._element.style[a2] = 0, this._triggerArray.length && i.default(this._triggerArray).removeClass(H).attr("aria-expanded", true), this.setTransitioning(true);
            ...
            if (i.default(this._element).trigger(e3), !e3.isDefaultPrevented()) {
              ...
              if (o2 > 0)
                for (var r2 = 0; r2 < o2; r2++) {
                  ...
                  null !== s2 && (i.default([].slice.call(document.querySelectorAll(s2))).hasClass(P) || i.default(a2).addClass(H).attr("aria-expanded", false));
                }
          ...
          return (t3 = a({}, B, t3)).toggle = Boolean(t3.toggle), u.typeCheckConfig(x, t3, Q), t3;
      ...
      i.default(document).on("click.bs.collapse.data-api", q, function(t2) {
      ...
      var U = "undefined" != typeof window && "undefined" != typeof document && "undefined" != typeof navigator, V = function() {
        for (var t2 = ["Edge", "Trident", "Firefox"], e2 = 0; e2 < t2.length; e2 += 1)
          if (U && navigator.userAgent.indexOf(t2[e2]) >= 0)
            return 1;
        return 0;
      ...
      function et(t2) {
        ...
        for (var e2 = tt(10) ? document.body : null, n2 = t2.offsetParent || null; n2 === e2 && t2.nextElementSibling; )
      ...
      function it(t2, e2) {
        ...
        if (t2 !== l2 && e2 !== l2 || i2.contains(o2))
          return "BODY" === (s2 = (a2 = l2).nodeName) || "HTML" !== s2 && et(a2.firstElementChild) !== a2 ? et(l2) : l2;
        var u2 = nt(t2);
      ...
      function _t(t2) {
        ...
        if ("BODY" === e2 || "HTML" === e2)
          return false;
        if ("fixed" === K(t2, "position"))
          return true;
        var n2 = X(t2);
        return !!n2 && _t(n2);
      }
      function vt(t2) {
        if (!t2 || !t2.parentElement || tt())
          return document.documentElement;
        for (var e2 = t2.parentElement; e2 && "none" === K(e2, "transform"); )
          e2 = e2.parentElement;
      ...
      var Bt = ["auto-start", "auto", "auto-end", "top-start", "top", "top-end", "right-start", "right", "right-end", "bottom-end", "bottom", "bottom-start", "left-end", "left", "left-start"], Qt = Bt.slice(3);
      function Wt(t2) {
      ...
      var Ut = { placement: "bottom", positionFixed: false, eventsEnabled: true, removeOnDestroy: false, onCreate: function() {
        ...
        var n2;
        if (!qt(t2.instance.modifiers, "arrow", "keepTogether"))
          return t2;
        var i2 = e2.element;
        if ("string" == typeof i2) {
        ...
        if (kt(t2.instance.modifiers, "inner"))
          return t2;
        ...
        return a2.forEach(function(s2, l2) {
          ...
          (c2 || _2 || E2) && (t2.flipped = true, (c2 || _2) && (i2 = a2[l2 + 1]), E2 && (r2 = function(t3) {
        ...
        if (!qt(t2.instance.modifiers, "hide", "preventOverflow"))
          return t2;
        ...
        }(t2, window.devicePixelRatio < 2 || !Mt), h2 = "bottom" === n2 ? "top" : "bottom", p2 = "right" === i2 ? "left" : "right", m2 = It("transform");
        if (s2 = "bottom" === h2 ? "HTML" === u2.nodeName ? -u2.clientHeight + c2.bottom : -f2.height + c2.bottom : c2.top, a2 = "right" === p2 ? "HTML" === u2.nodeName ? -u2.clientWidth + c2.right : -f2.width + c2.right : c2.left, l2 && m2)
          d2[m2] = "translate3d(" + a2 + "px, " + s2 + "px, 0)", d2[h2] = 0, d2[p2] = 0, d2.willChange = "transform";
        else {
        ...
        var e2, n2;
        return Ht(t2.instance.popper, t2.styles), e2 = t2.instance.popper, n2 = t2.attributes, Object.keys(n2).forEach(function(t3) {
          false !== n2[t3] ? e2.setAttribute(t3, n2[t3]) : e2.removeAttribute(t3);
        }), t2.arrowElement && Object.keys(t2.arrowStyles).length && Ht(t2.arrowElement, t2.arrowStyles), t2;
        ...
        return e2.setAttribute("x-placement", a2), Ht(e2, { position: n2.positionFixed ? "fixed" : "absolute" }), n2;
      ...
      var Yt = Vt, zt = "dropdown", Kt = "bs.dropdown", Xt = i.default.fn[zt], Gt = new RegExp("38|40|27"), $t = "disabled", Jt = "show", Zt = "dropdown-menu-right", te = "hide.bs.dropdown", ee = "hidden.bs.dropdown", ne = "click.bs.dropdown.data-api", ie = "keydown.bs.dropdown.data-api", oe = '[data-toggle="dropdown"]', re = ".dropdown-menu", ae = { offset: 0, flip: true, boundary: "scrollParent", reference: "toggle", display: "dynamic", popperConfig: null }, se = { offset: "(number|string|function)", flip: "boolean", boundary: "(string|element)", reference: "(string|element)", display: "string", popperConfig: "(null|object)" }, le = function() {
        ...
        return e2.toggle = function() {
          ...
          if (!e3 || 3 !== e3.which && ("keyup" !== e3.type || 9 === e3.which))
            for (var n2 = [].slice.call(document.querySelectorAll(oe)), o2 = 0, r2 = n2.length; o2 < r2; o2++) {
          ...
          if (!(/input|textarea/i.test(e3.target.tagName) ? 32 === e3.which || 27 !== e3.which && (40 !== e3.which && 38 !== e3.which || i.default(e3.target).closest(re).length) : !Gt.test(e3.which)) && !this.disabled && !i.default(this).hasClass($t)) {
            ...
            if (o2 || 27 !== e3.which) {
              if (e3.preventDefault(), e3.stopPropagation(), !o2 || 27 === e3.which || 32 === e3.which)
                return 27 === e3.which && i.default(n2.querySelector(oe)).trigger("focus"), void i.default(this).trigger("click");
      ...
      var ue = "bs.modal", fe = i.default.fn.modal, de = "modal-open", ce = "fade", he = "show", pe = "modal-static", me = "hidden.bs.modal", ge = "show.bs.modal", _e = "focusin.bs.modal", ve = "resize.bs.modal", be = "click.dismiss.bs.modal", ye = "keydown.dismiss.bs.modal", Ee = "mousedown.dismiss.bs.modal", we = ".fixed-top, .fixed-bottom, .is-fixed, .sticky-top", Te = { backdrop: true, keyboard: true, focus: true, show: true }, Ce = { backdrop: "(boolean|string)", keyboard: "boolean", focus: "boolean", show: "boolean" }, Se = function() {
        ...
        return e2.toggle = function(t3) {
          ...
          if (this._isShown && this._config.backdrop) {
            ...
            }), n2 && u.reflow(this._backdrop), i.default(this._backdrop).addClass(he), !t3)
              return;
            if (!n2)
              return void t3();
        ...
        for (var i2 = new window.DOMParser().parseFromString(t2, "text/html"), o2 = Object.keys(e2), r2 = [].slice.call(i2.body.querySelectorAll("*")), a2 = function(t3, n3) {
          ...
          s3.forEach(function(t4) {
            (function(t5, e3) {
              ...
              if (-1 !== e3.indexOf(n4))
                return -1 === Ne.indexOf(n4) || Boolean(De.test(t5.nodeValue) || Ae.test(t5.nodeValue));
              for (var i4 = e3.filter(function(t6) {
                return t6 instanceof RegExp;
              }), o3 = 0, r3 = i4.length; o3 < r3; o3++)
                if (i4[o3].test(n4))
                  return true;
              return false;
            })(t4, l3) || i3.removeAttribute(t4.nodeName);
          });
        }, s2 = 0, l2 = r2.length; s2 < l2; s2++)
          a2(s2);
        ...
        return e2.enable = function() {
          ...
          if (this.isWithContent() && this._isEnabled) {
            ...
            var d2 = function() {
              ...
              t3._hoverState = null, i.default(t3.element).trigger(t3.constructor.Event.SHOWN), e4 === He && t3._leave(null, t3);
            };
          ...
          this.config.trigger.split(" ").forEach(function(e3) {
            if ("click" === e3)
              i.default(t3.element).on(t3.constructor.Event.CLICK, t3.config.selector, function(e4) {
                return t3.toggle(e4);
              });
            else if ("manual" !== e3) {
              var n2 = e3 === Me ? t3.constructor.Event.MOUSEENTER : t3.constructor.Event.FOCUSIN, o2 = e3 === Me ? t3.constructor.Event.MOUSELEAVE : t3.constructor.Event.FOCUSOUT;
          ...
          (e3 = e3 || i.default(t3.currentTarget).data(n2)) || (e3 = new this.constructor(t3.currentTarget, this._getDelegateConfig()), i.default(t3.currentTarget).data(n2, e3)), t3 && (e3._activeTrigger["focusin" === t3.type ? qe : Me] = true), i.default(e3.getTipElement()).hasClass(Fe) || e3._hoverState === Re ? e3._hoverState = Re : (clearTimeout(e3._timeout), e3._hoverState = Re, e3.config.delay && e3.config.delay.show ? e3._timeout = setTimeout(function() {
            e3._hoverState === Re && e3.show();
          }, e3.config.delay.show) : e3.show());
        }, e2._leave = function(t3, e3) {
          var n2 = this.constructor.DATA_KEY;
          (e3 = e3 || i.default(t3.currentTarget).data(n2)) || (e3 = new this.constructor(t3.currentTarget, this._getDelegateConfig()), i.default(t3.currentTarget).data(n2, e3)), t3 && (e3._activeTrigger["focusout" === t3.type ? qe : Me] = false), e3._isWithActiveTrigger() || (clearTimeout(e3._timeout), e3._hoverState = He, e3.config.delay && e3.config.delay.hide ? e3._timeout = setTimeout(function() {
            e3._hoverState === He && e3.hide();
          ...
          this._offsets = [], this._targets = [], this._scrollHeight = this._getScrollHeight(), [].slice.call(document.querySelectorAll(this._selector)).map(function(t4) {
            ...
            if (r2 && (e4 = document.querySelector(r2)), e4) {
              ...
              if (a2.width || a2.height)
                return [i.default(e4)[n2]().top + o2, r2];
            }
            return null;
          }).filter(function(t4) {
            return t4;
...
// dep:admin-lte_plugins_bootstrap_js_bootstrap_bundle_min_js
var admin_lte_plugins_bootstrap_js_bootstrap_bundle_min_js_default = require_bootstrap_bundle_min();
export {
  admin_lte_plugins_bootstrap_js_bootstrap_bundle_min_js_default as default
};
/*!
  ...
  */
//# sourceMappingURL=admin-lte_plugins_bootstrap_js_bootstrap_bundle_min_js.js.map
